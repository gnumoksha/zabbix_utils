...
*/30 * * * * zabbix $dir_externalscripts/sender_download_speed.sh --config=$zabbixagentconfig"

echo
echo "Se quiser medir o download e upload com o speedtest, adicione no cron:
*/30 * * * * zabbix $dir_externalscripts/sender_speedtest.sh --config=$zabbixagentconfig"
